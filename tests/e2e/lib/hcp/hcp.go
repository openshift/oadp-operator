...
func (h *HCHandler) DeleteHCPNamespace(shouldWait bool) error {
	...
	err := wait.PollUntilContextTimeout(h.Ctx, WaitForNextCheckTimeout, WaitForObjectDeletionTimeout, true, func(ctx context.Context) (bool, error) {
...
func (h *HCHandler) WaitForHCDeletion() error {
	return wait.PollUntilContextTimeout(h.Ctx, WaitForNextCheckTimeout, WaitForObjectDeletionTimeout, true, func(ctx context.Context) (bool, error) {
...
func (h *HCHandler) DeployHCManifest(tmpl, provider string, hcName string) (*hypershiftv1.HostedCluster, error) {
	...
	err = wait.PollUntilContextTimeout(h.Ctx, WaitForNextCheckTimeout, WaitForObjectToBePresentTimeout, true, func(ctx context.Context) (bool, error) {
...
func ValidateHCP(timeout time.Duration, contingencyTimeout time.Duration, deployments []string, hcpNamespace string) func(client.Client, string) error {
	...
	if contingencyTimeout == 0 {
		contingencyTimeout = ContingencyTimeout
	}
