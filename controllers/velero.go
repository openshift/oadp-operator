...
func (r *DPAReconciler) customizeVeleroDeployment(veleroDeployment *appsv1.Deployment) error {
	...
	return r.appendPluginSpecificSpecs(veleroDeployment, veleroContainer, providerNeedsDefaultCreds, hasCloudStorage)
}

// add plugin specific specs to velero deployment
func (r *DPAReconciler) appendPluginSpecificSpecs(veleroDeployment *appsv1.Deployment, veleroContainer *corev1.Container, providerNeedsDefaultCreds map[string]bool, hasCloudStorage bool) error {
	dpa := r.dpa
