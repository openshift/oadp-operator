...
| `TEST_VIRT` | Enable Virtual Machine backup/restore testing | Copied from OPENSHIFT_CI, so that VM testing does not unintentionally run on local E2E tests  | false |
