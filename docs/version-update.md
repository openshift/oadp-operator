...
For a patch version update (e.g., 1.3.9 → 1.3.10), update these 4 files:
...
```makefile
DEFAULT_VERSION := 1.3.10  # was 1.3.9
```
...
metadata:
  annotations:
    olm.skipRange: '>=0.0.0 <1.3.10'  # was <1.3.9
  name: oadp-operator.v1.3.0  # UNCHANGED - base version for 1.3.x branch
spec:
  replaces: oadp-operator.v1.3.9  # was v1.3.8
  version: 1.3.10  # was 1.3.9
```
...
metadata:
  annotations:
    olm.skipRange: '>=0.0.0 <1.3.10'  # was <1.3.9
  name: oadp-operator.v1.3.10  # was v1.3.9
spec:
  replaces: oadp-operator.v1.3.9  # was v1.3.8
  version: 1.3.10  # was 1.3.9
```
...
channels:
- name: stable-1.3
  currentCSV: oadp-operator.v1.3.10  # was v1.3.9
```
