...
| bucket   | [*CloudStorageLocation](https://pkg.go.dev/github.com/openshift/oadp-operator@master/api/v1alpha1#CloudStorageLocation) | Location to store volume snapshots. For further details, see  [here](config/bsl_and_vsl.md). |
