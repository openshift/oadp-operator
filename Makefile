...
.PHONY:ginkgo
ginkgo: # Make sure ginkgo is in $pwd/bin
	$(call go-install-tool,$(GINKGO),github.com/onsi/ginkgo/v2/ginkgo@v2.9.2)
.PHONY: ginkgo-build
ginkgo-build: ginkgo
	$(GINKGO) build -mod=mod ./...
...
IMG ?= quay.io/konveyor/oadp-operator:oadp-1.1
