...
$(GOLANGCI_LINT): $(LOCALBIN)
	$(call go-install-tool-with-version,$(GOLANGCI_LINT),github.com/golangci/golangci-lint/cmd/golangci-lint,${GOLANGCI_LINT_VERSION})

# go-install-tool-with-version will 'go install' any package with custom target and name of binary, if it doesn't exist
# $1 - target path with name of binary with version
# $2 - package url which can be installed
# $3 - specific version of package
define go-install-tool-with-version
@[ -f $(1) ] || { \
set -e; \
package=$(2)@$(3) ;\
