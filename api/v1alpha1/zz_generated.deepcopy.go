...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OADPResourceRequirements) DeepCopyInto(out *OADPResourceRequirements) {
	*out = *in
	if in.Limits != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OADPResourceRequirements.
func (in *OADPResourceRequirements) DeepCopy() *OADPResourceRequirements {
	if in == nil {
		return nil
	}
	out := new(OADPResourceRequirements)
	in.DeepCopyInto(out)
	return out
}
