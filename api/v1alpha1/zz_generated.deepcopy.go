...
func (in *ApplicationConfig) DeepCopyInto(out *ApplicationConfig) {
	*out = *in
	...
	if in.KubevirtDatamover != nil {
		in, out := &in.KubevirtDatamover, &out.KubevirtDatamover
		*out = new(KubevirtDatamoverConfig)
		(*in).DeepCopyInto(*out)
	}
...
func (in *DataProtectionApplicationSpec) DeepCopyInto(out *DataProtectionApplicationSpec) {
	*out = *in
	...
	if in.VMFileRestore != nil {
		in, out := &in.VMFileRestore, &out.VMFileRestore
		*out = new(VMFileRestore)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubevirtDatamoverConfig) DeepCopyInto(out *KubevirtDatamoverConfig) {
	*out = *in
	if in.MaxIncrementalBackups != nil {
		in, out := &in.MaxIncrementalBackups, &out.MaxIncrementalBackups
		*out = new(int32)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubevirtDatamoverConfig.
func (in *KubevirtDatamoverConfig) DeepCopy() *KubevirtDatamoverConfig {
	if in == nil {
		return nil
	}
	out := new(KubevirtDatamoverConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMFileRestore) DeepCopyInto(out *VMFileRestore) {
	*out = *in
	if in.Enable != nil {
		in, out := &in.Enable, &out.Enable
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMFileRestore.
func (in *VMFileRestore) DeepCopy() *VMFileRestore {
	if in == nil {
		return nil
	}
	out := new(VMFileRestore)
